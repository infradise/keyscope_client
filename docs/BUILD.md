...
```yaml
# version: 3.2.0  # Previous version
version: 3.3.0   # New version
```
...
Create a new release on GitHub. Use the tag you just created (e.g., `v3.3.0`). Copy the relevant section from `CHANGELOG.md` into the release notes.
