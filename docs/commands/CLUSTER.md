...
|-------------------------------|-------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------|--------------------|
| `asking`                      | [ASKING](https://redis.io/docs/latest/commands/asking/)                                               | [ASKING](https://valkey.io/commands/asking/)                                               | CME only |
...
| `clusterCountFailureReports`  | [CLUSTER COUNT-FAILURE-REPORTS](https://redis.io/docs/latest/commands/cluster-count-failure-reports/) | [CLUSTER COUNT-FAILURE-REPORTS](https://valkey.io/commands/cluster-count-failure-reports/) | CME only |
| `clusterCountKeysInSlot`      | [CLUSTER COUNTKEYSINSLOT](https://redis.io/docs/latest/commands/cluster-countkeysinslot/)             | [CLUSTER COUNTKEYSINSLOT](https://valkey.io/commands/cluster-countkeysinslot/)             | CME only |
...
| `clusterGetKeysInSlot`        | [CLUSTER GETKEYSINSLOT](https://redis.io/docs/latest/commands/cluster-getkeysinslot/)                 | [CLUSTER GETKEYSINSLOT](https://valkey.io/commands/cluster-getkeysinslot/)                 | CME only |
...
| `clusterHelp`                 | [CLUSTER HELP](https://redis.io/docs/latest/commands/cluster-help/)                                   | [CLUSTER HELP](https://valkey.io/commands/cluster-help/)                                   | CME only |
| `clusterInfo`                 | [CLUSTER INFO](https://redis.io/docs/latest/commands/cluster-info/)                                   | [CLUSTER INFO](https://valkey.io/commands/cluster-info/)                                   | CME only |
| `clusterKeySlot`              | [CLUSTER KEYSLOT](https://redis.io/docs/latest/commands/cluster-keyslot/)                             | [CLUSTER KEYSLOT](https://valkey.io/commands/cluster-keyslot/)                             | CME only |
| `clusterLinks`                | [CLUSTER LINKS](https://redis.io/docs/latest/commands/cluster-links/)                                 | [CLUSTER LINKS](https://valkey.io/commands/cluster-links/)                                 | CME only |
...
| `clusterMyId`                 | [CLUSTER MYID](https://redis.io/docs/latest/commands/cluster-myid/)                                   | [CLUSTER MYID](https://valkey.io/commands/cluster-myid/)                                   | CME only |
...
| `clusterNodes`                | [CLUSTER NODES](https://redis.io/docs/latest/commands/cluster-nodes/)                                 | [CLUSTER NODES](https://valkey.io/commands/cluster-nodes/)                                 | CME only |
| `clusterReplicas`             | [CLUSTER REPLICAS](https://redis.io/docs/latest/commands/cluster-replicas/)                           | [CLUSTER REPLICAS](https://valkey.io/commands/cluster-replicas/)                           | CME only |
...
| `clusterShards`               | [CLUSTER SHARDS](https://redis.io/docs/latest/commands/cluster-shards/)                               | [CLUSTER SHARDS](https://valkey.io/commands/cluster-shards/)                               | CME only |
...
| `clusterSlots`                | [CLUSTER SLOTS](https://redis.io/docs/latest/commands/cluster-slots/)                                 | [CLUSTER SLOTS](https://valkey.io/commands/cluster-slots/)                                 | CME only |
...
| `readOnly`                    | [READONLY](https://redis.io/docs/latest/commands/readonly/)                                           | [READONLY](https://valkey.io/commands/readonly/)                                           | CME only |
| `readWrite`                   | [READWRITE](https://redis.io/docs/latest/commands/readwrite/)                                         | [READWRITE](https://valkey.io/commands/readwrite/)                                         | CME only |